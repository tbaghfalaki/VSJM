...
VS <- VS(formFixed, formRandom, formGroup, formSurv,
         nmark = 3, K1 = 15, K2 = 15,
         model = model, n.chains1 = 1, n.iter1 = 3000, n.burnin1 = 1000,
...
DP0<- DP0(VS, s = 0.1, t = 0.5, n.chains = 1, n.iter = 2000, n.burnin = 1000,
          n.thin = 1,cause_main=1,
          DIC = TRUE, quiet = FALSE, dataLong = dataLong_v, dataSurv = dataSurv_v
)
\dontrun{
  ...
  Criteria(s = 0.1, t = 0.5, Survt = dataSurv_v$survtime,
           CR = dataSurv_v$CR, P = DP0$DP$est, cause = 1)$Cri


  Criteria(s = 0.1, t = 0.5, Survt = dataSurv_v$survtime,
           CR = dataSurv_v$CR, P = MCDP$DP$est, cause = 1)$Cri
  ######################################################################
  rm(list=ls())
  data(dataLong_m)
  data(dataSurv_m)
  ...
  VS <- VS(formFixed, formRandom, formGroup, formSurv,
           nmark = 2, K1 = 15, K2 = 15,
           model = model, n.chains1 = 2, n.iter1 = 3000, n.burnin1 = 1000,
           n.thin1 = 1,  n.chains2 = 2, n.iter2 = 3000, n.burnin2 = 1000,
           n.thin2 = 1, simplify=TRUE, Obstime = "obstime", Method = "DS", ncl = 2,
           DIC = TRUE, quiet = FALSE, dataLong_t, dataSurv_t
  )
  ...
  Step2 <- VS2(VS,
               Method = "LBFDR", n.chains = 2, n.iter = 3000, n.burnin = 2000,
               n.thin = 1, dataLong = dataLong_t, dataSurv = dataSurv_t
  )
